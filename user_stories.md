As a developer, I want to create a function that tallies the number of clicks per image because the marketing person would like to use that data for their analysis. 
